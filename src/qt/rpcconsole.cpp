...
//TODO: whatever this connects to likely needs modified
        setNumBlocks(model->getNumBlocks(), model->getNumHeaders());
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the OCore RPC console.") + "<br>" +

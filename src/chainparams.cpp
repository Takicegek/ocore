...
public:
    CMainParams() {
        ...
        genesis.nVersion = 1;
	    genesis.nHeight  = 0;
        genesis.nTime    = 1474255127;
        genesis.nNonce   = 170570;

        hashGenesisBlock = genesis.GetHash();
        //printf("%s\n", genesis.GetHash().ToString().c_str());
        //printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(genesis.hashMerkleRoot == uint256("0x0f07d7a6afc812f0eff4e0fefd865c5f1243c7ecea22716080fef6b6008c876e"));
        if(hashGenesisBlock != uint256("0x00000300a71e50648e26b6b1e3df9c41178a4e06671a0f73114d82067f0a4cfa"))
		MineGenesis(genesis);
...
//        assert(hashGenesisBlock == uint256("0xcc9c9f3b61e8422bc54b86925238262a2994f265aea14b5e10e3d2fd4cb413a8"));
	...
	if(hashGenesisBlock!= uint256("0000069d96f7f6135475139bc49f268997cb14850aae8feedf70047cfd89291a")){
        ...
        vFixedSeeds.clear();
	vSeeds.push_back(CDNSSeedData("seed.ocore.info", "seed.ocore.info"));

...
#if defined(NDEBUG)
# error "OCore cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "OCore Signed Message:\n";
...
printAffairs();
    ...
    tmpPoint = mapBlockIndex[Params().HashGenesisBlock()];
    if(syncPoint==0 && triePoint != 0 && triePoint != tmpPoint){
